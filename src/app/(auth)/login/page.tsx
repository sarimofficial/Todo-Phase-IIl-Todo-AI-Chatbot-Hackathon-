...
export default function LoginPage() {
  return (
    <div className="min-h-screen bg-transparent flex flex-col items-center justify-center px-4 relative overflow-hidden">
      {/* Background Blobs */}
      <div className="absolute top-1/4 -left-20 w-96 h-96 bg-indigo-300 dark:bg-indigo-900/20 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob"></div>
      <div className="absolute bottom-1/4 -right-20 w-96 h-96 bg-purple-300 dark:bg-purple-900/20 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob animation-delay-2000"></div>
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-500 dark:text-gray-400 mt-2">Sign in to manage your AI-powered tasks</p>
        </div>
